...
# Lista de Áreas disponíveis no Menu
AREAS = [
    "Direito Civil",
    "Direito Penal",
...
def get_questions_by_area(area: str):
    return [q for q in QUESTIONS if q["area"] == area]
...
def build_quiz(area: str, mode: str, n: int):
    ...
    return {
        ...
        "pos": 0,
        "score": 0,
        "answers": [],  # list of dicts: {id, chosen, correct}
    }
...
def answer():
    ...
    # no modo treino, mostra feedback imediato na mesma página
    if quiz["mode"] == "treino":
